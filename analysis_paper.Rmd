...
pfp_con <- ggplot() +
  ...
  xlab("Acceptance Ratings") + ylab("log(RT) in seconds") +
...
pro_con <- ggplot() +
  ...
  xlab("Acceptance Ratings") + ylab("P(Regression Out)") +
  ggtitle("FP Regression Out: Consequent")
...
pro_spill <- 
  ...
  coord_cartesian(xlim = c(2.5, 6.2), ylim = ylim_bin, expand = FALSE) +
  xlab("Acceptance Ratings") + ylab("P(Regression Out)") +
  ggtitle("FP Regression Out: Spillover")
...
prp_con <- ggplot() +
  ...
  coord_cartesian(xlim = c(2.5, 6.2), ylim = min_con, expand = FALSE) +
  xlab("Acceptance Ratings") + ylab("log(RT) in seconds") +
  ggtitle("RP Reading Times: Consequent")
...
prp_spill <- 
  ...
  coord_cartesian(xlim = c(2.5, 6.2), ylim = min_spill, expand = FALSE) +
  xlab("Acceptance Ratings") + ylab("log(RT) in seconds") +
  ggtitle("RP Reading Times: Spillover")
...
ptt_con <- ggplot() +
  ...
  coord_cartesian(xlim = c(2.5, 6.2), ylim = min_con, expand = FALSE) +
  xlab("Acceptance Ratings") + ylab("log(RT) in seconds") +
  ggtitle("Total Reading Times: Consequent")
...
ptt_spill <- 
  ...
  coord_cartesian(xlim = c(2.5, 6.2), ylim = min_spill, expand = FALSE) +
  xlab("Acceptance Ratings") + ylab("log(RT) in seconds") +
  ggtitle("Total Reading Times: Spillover")
...
pdf("figure2.pdf", width = 13, height = 6)
