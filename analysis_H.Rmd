---
title: "Analysis of First Pas Reading Times"
...
The goal of the following analysis was to see whether the explanatory goodness of fit would affect the DVs. However, there were two different variables representing the explanatory goodness of fit: the experimenter assigned binary variable `Fit` with levels 'high' and 'low' and the continuous variable `Accepts` representing how a different group of participants judged the explanatory fit. In addition, we also have a confidence rating for the continuous fit rating, variable `Confident`.
